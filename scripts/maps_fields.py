...
class Galaxy_maps:
    ...
    def save_data(self,name_galaxy):
        ...
        print(f'{self.path_directory+'{}_.fits'.format(f'{name_galaxy}_moment0')}')
        print(f'{self.path_directory+'{}_.fits'.format(f'{name_galaxy}_moment1')}')
        print(f'{self.path_directory+'{}_.fits'.format(f'{name_galaxy}_moment2')}')
    ...
    def plot_fields(self):
        ...
        cb = plt.imshow(self.moment1_data,cmap='RdBu_r',vmin=4757.7983,vmax=5400)
        ax.set_xlabel('RA')
        ax.set_ylabel('Dec')
        cbar = fig.colorbar(cb)
        cbar.minorticks_on()
    ...
    def plot_overlays(self):
        ...
        ax.contour(hi_reprojected_1, levels=np.arange(4800,5300,25),cmap='RdBu_r')
        ax.set_xlabel('RA', size=18,family='serif')
        ax.set_ylabel('Dec', size=18,family='serif')
        plt.xticks(fontsize=15)
        plt.yticks(fontsize=15)
        ...
        ax.contour(hi_reprojected_2, levels=np.arange(0,int(np.ceil(np.nanmax(hi_reprojected_2))),10),cmap='viridis')
        ax.set_xlabel('RA', size=18,family='serif')
        ax.set_ylabel('Dec', size=18,family='serif')
        plt.xticks(fontsize=15)
        plt.yticks(fontsize=15)
